...
echo_and_run cd "/home/suryak/ECE3091-S2-2021/src/comms"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/suryak/ECE3091-S2-2021/src/comms/setup.py" \
     \
    build --build-base "/home/suryak/ECE3091-S2-2021/build/comms" \
    install \
    --root="${DESTDIR-/}" \
